...
public class MainCameraOld : MonoBehaviour
{

    // public GameObject target;
    //  public playerControllerOld playerControllerOld;
    public static MainCameraOld mainCamera;
    ...
    bool playerRaycastHitSomeThing
    {
        get
        {
            return Physics.Linecast(PlayerControllerOld.playerControllerOld.PlayerCollider[1].bounds.center, transform.position, out playerHit, WallMask);
        }
    }
    ...
    void LateUpdate()
    {
        ...
        Vector3 nowpos;
        distenceControl();
        nowpos = rotationEuler * new Vector3(0, 0, -distence) + PlayerControllerOld.playerControllerOld.Player_pre_pos.position;
        ...
        // transform.position = Vector3.Lerp(transform.position, rotationEuler * new Vector3(0, 0, -distence) + playerControllerOld.playerControllerOld.Player_pre_pos.position, 1f);

       

        Debug.DrawLine(PlayerControllerOld.playerControllerOld.PlayerCollider[1].bounds.center, transform.position, Color.green);
    ...
    private void Rotaion()
    {
        ...
        CameraLookAt_X += Input.GetAxis("Mouse X") * PlayerControllerOld.playerControllerOld.RotationSpeed * Time.deltaTime;
    ...
    {
        //playerRaycastHitSomeThing = Physics.Linecast(playerControllerOld.playerControllerOld.PlayerCollider[1].center, transform.position, out playerHit);
    ...
    public Vector3 GetAimTarget()
    {
        ...
        longAttackRaycastHitSomeThing = Physics.Raycast(transform.position, transform.forward, PlayerControllerOld.playerControllerOld.LongAttackMaxDis);
