...
public class PlayerControllerOld : MonoBehaviour {
    ...
    public static PlayerControllerOld playerControllerOld;
   ...
   // public Transform PlayerHead;
       ...
       if(playerAnimatorState == PlayerAnimatorState.Movement || playerAnimatorState == PlayerAnimatorState.Attack || playerAnimatorState == PlayerAnimatorState.Avoid && IsGround) 
       {
            ...
            else if (Input.GetMouseButtonDown(1))
            {
                ...
                {                                    
                    ...
                    //LongAttackBullet_Object.transform.rotation = Quaternion.LookRotation(MainCameraOld.mainCamera.GetAimTarget());
    ...
    {           
        ...
        Bullet.transform.rotation = Quaternion.LookRotation(MainCameraOld.mainCamera.GetAimTarget());
                      
        if (MainCameraOld.mainCamera.longAttackRaycastHitSomeThing && MainCameraOld.mainCamera.RayHitPoint.transform.CompareTag("Wall") && MainCameraOld.mainCamera.RayHitPoint.transform.CompareTag("Floor") && MainCameraOld.mainCamera.RayHitPoint.transform.CompareTag("Enemy"))
        {
            LongAttackEndPos = MainCameraOld.mainCamera.GetAimTarget();
           // Debug.Log(MainCameraOld.mainCamera.RayHitPoint.transform.name);
                       
        }
        else
        {
            LongAttackEndPos = Quaternion.LookRotation(MainCameraOld.mainCamera.GetAimTarget()) * new Vector3(1, 0, LongAttackMaxDis) + Bullet.transform.position;
